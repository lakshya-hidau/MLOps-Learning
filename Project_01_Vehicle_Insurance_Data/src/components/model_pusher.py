...
from src.entity.storage_estimator import Proj1Estimator
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        """
        self.s3 = SimpleObjectStorageService()
        self.model_evaluation_artifact = model_evaluation_artifact
        self.model_pusher_config = model_pusher_config
        self.proj1_estimator = Proj1Estimator(repo_id=model_pusher_config.repo_id,
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        try:
            ...
            model_pusher_artifact = ModelPusherArtifact(repo_id=self.model_pusher_config.repo_id,
