...
class TrainPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("Getting the data from MongoDB to feature store")
            data_ingestion = DataIngestion(data_ingestion_config=self.data_ingestion_config)
            data_ingestion_artifact = data_ingestion.initiate_data_ingestion()
            logging.info("Got the train_set and test_set from the data ingestion component")
    ...
    def run_pipeline(self) -> None:
        ...
        try:
            ...
            if not model_evaluation_artifact.is_model_accepted:
                logging.info("Trained model is not better than the best model present in S3. Hence not pushing the model to S3 bucket")
                return None
